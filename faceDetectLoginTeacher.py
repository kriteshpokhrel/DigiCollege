    ...
    def detect_face(self):
        ...
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                mycursor.execute("select sal, T_Name, t_ID  from digiFaceTeacher where id=" + str(id))
                ...
                if confidence > 74:
                    global detect
                    detect += 1
                    cv2.putText(img, T_Name, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.8, color, 1, cv2.LINE_AA)
